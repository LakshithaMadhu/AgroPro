  ...
  return(
    ...
    <View style={styles.container}>
     ...
     <Text style={styles.head}>Agro Pro</Text>
      ...
      <Button title='Sign In' style={styles.btn1} color={'red'}  onPress={(handleSignIn) } />
...
const styles = StyleSheet.create({
  ...
  img:{
    width:220,height:220,marginTop:20,borderColor:'white',borderWidth:2,borderRadius:30
  },
  head:{
