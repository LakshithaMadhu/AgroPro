...
const App = ({ navigation }) =>{
  ...
  return(
    ...
    <View style={styles.container}>
     ...
     <Text style={styles.head}>Agro Pro</Text>
      ...
      <Button title='Reset Password' style={styles.btn1} color={'red'}  onPress={() => Alert.alert('Reset Email Send Succuessfully')}/>
...
const styles = StyleSheet.create({
  ...
  ,footert:{
    ...
    color:'white',marginBottom:10,fontSize:16,fontWeight:'bold',color:'white',marginHorizontal:25
  }
